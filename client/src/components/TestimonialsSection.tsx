...
const testimonials = [
  {
    id: 1,
    name: "Priya Sharma",
    review: "Absolutely love the ambiance and the food! The sushi is so fresh and the dimsums are to die for. Best Asian fusion restaurant in Ahmedabad!",
    rating: 5,
    thumbnail: thumb1,
    platform: "Instagram",
  },
  {
    id: 2,
    name: "Rahul Patel",
    review: "The Bowl of the Month is a must-try! Every visit is a new culinary adventure. The staff is incredibly friendly and the service is top-notch.",
    rating: 5,
    thumbnail: thumb2,
    platform: "Instagram",
  },
  {
    id: 3,
    name: "Ananya Desai",
    review: "Perfect spot for a date night or family dinner. The Lolloccino beverages are amazing! Loved the matcha latte. Will definitely come back.",
    rating: 5,
    thumbnail: thumb3,
    platform: "Google",
  },
  {
    id: 4,
    name: "Karan Mehta",
    review: "Exceptional quality and presentation. The Dragon Roll is a masterpiece! Great value for money and the portions are generous.",
    rating: 5,
    thumbnail: thumb4,
    platform: "Zomato",
  },
  {
    id: 5,
    name: "Sneha Joshi",
    review: "I've been to all four locations and each one has its own charm. The Bodakdev outlet is my favorite! Highly recommend the dimsum platter.",
    rating: 5,
    thumbnail: thumb5,
    platform: "Instagram",
  },
